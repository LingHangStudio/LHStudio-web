            ...
            <div className='java_body'>
                <div className='java_vis'>
                    <div className='java_head'>
                        <div className='java_head_title' style={{ fontFamily: 'BigYoungBGB21c799f3dfa1ffbd' }}><h1 className="css1c799f3dfa1ffbd" >领航工作室</h1>   <h1 className="css1c799f3dfa1ffbd" >后台开发组</h1></div>
                        <p>
                            JAVA 是一门面向对象编程语言，
                            全球编程语言流行榜第一名。
                            Java不仅吸收了C++语言的各种优点，
                    ...
                    <div className='java_h' style={{ backgroundColor: '#8a0a0a', flexWrap: 'wrap-reverse' }}>
                        ...
                        <div className='java_item2'>
                            <img src={require('../img/java_s.jpg')}></img>
                        </div>
                    </div>
                    <div className='java_h' style={{ backgroundColor: 'white' }}>
                        <div className='java_item3'>
                            <img src={require('../img/java_j.jpg')}></img>
                        </div>
                        <div className='java_item4'>
                            <p>强大且易用的java，带你走进后台开发的世界</p>
                            {/* <div className = 'java_item4_ps'>学习java基础知识，学习使用SpringBoot快速创建后台项目，学习Linux系统，学习mysql等数据库，学习rides，nginx，tomcat等服务器知识，庞大的知识体系满足你的求知欲望</div> */}
                        </div>
                    </div>
                    <div className='java_h' style={{ backgroundColor: 'white', flexWrap: 'wrap-reverse' }}>
                        <div className='java_item5' >
                            <p>学习java基础知识，学习使用SpringBoot快速创建后台项目，学习Linux系统，学习mysql等数据库，学习rides，nginx，tomcat等服务器知识，庞大的知识体系满足你的求知欲望</p>
                        </div>
                        <div className='java_item6'>
                            <img src={require('../img/java_u.jpg')}></img>
                        </div>
                    </div>
